...
<details> 
  ...
  <p>in development:</p>
  <ul>
    <li> <b>Системы пакетной обработки</b> - Пользователи подготавливали перфокарты, содержащие данные и программы и передавали их в вычислительный центр. Вводили их в комьютер специально обученные люди - операторы. Распечатанные результаты пользователь обычно получал уже на следующий день. 
    </li>
    <li> <b>Многотерминальные системы</b> -  </li>
    <li> <b>Появление глобальных сетей</b> -  </li>
...
## 14 Стандартные стоки коммуникационных протоколов
<details> 
  <summary></summary>
  <p>
...
## 15 Особенности локальных, глобальных, городских сетей (1.4.1)
<details> 
  <summary></summary>
  <p>
